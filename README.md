...
Besides standard depp learning rules (the testing dataset must not be used for training or fine-tuning  the model, nor for training dataset augmentation), the following rules applied:
